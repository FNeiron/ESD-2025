package com.company.autotaxi.test_support;

import com.company.autotaxi.AutoTaxiApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.autotaxi.screen")
@ContextConfiguration(classes = {AutoTaxiApplication.class, UiTestAssistConfiguration.class})
